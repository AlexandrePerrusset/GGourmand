...
//		
//		
//		log.warn("Nombres de r�sultats eatery : "+respEat.getHits().getTotalHits());
//		log.warn("Nombres de r�sultats cities : "+respEatCities.getHits().getTotalHits());
		SearchHits hits;
