    ...
    <nav>
      <div class="nav-wrapper">
            <img src="sources/logo.jpg" class="logo1">
             <a href="index.html" class="brand-logo logoGG text-darken-2 titleStyle"> Gastronome  Gourmand</a>
  ...
  <div id="modal1" class="modal col s3 modalBox">
    <div class="modal-content">
      <form class="col s3">
        ...
        <a class="waves-effect waves-light btn-large modalLink">Se connecter</a>
      </form>
 ...
 <div class="col s3">
               ...
               <div class="card">
                  <div class="card-image">
                    <img src="sources/user.jpg" alt="" class="circle responsive-img" class="photouser">
                  </div>
...
<div class="col s9">
        ...
        <div class="card horizontal">
          <div class="row">
                ...
                <div class="col s4">Heure</div>
                <div class="col s4">Personnes</div>
